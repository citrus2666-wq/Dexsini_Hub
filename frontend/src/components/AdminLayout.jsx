...
import {
    Clock, Settings, LogOut, Menu, X, UserCheck, LayoutDashboard, Users, Calendar
} from 'lucide-react'
...
const AdminLayout = () => {
    ...
    const sidebarItems = [
        ...
        { icon: UserCheck, label: 'Leaves', path: '/admin/leaves' },
        { icon: Calendar, label: 'Calendar', path: '/admin/calendar' },
        { icon: Clock, label: 'Overtime', path: '/admin/overtime' },
        ...
        <div style={{ display: 'flex', height: '100vh', width: '100vw', overflow: 'hidden', background: 'var(--bg-deep)' }}>
            ...
            <motion.div
                ...
                style={{
                    ...
                    zIndex: 10,
                    background: '#ffffff' /* Explicit white sidebar */
                }}
            >
