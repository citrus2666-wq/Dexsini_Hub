...
const ManagerLayout = () => {
    ...
    const sidebarItems = [
        ...
        { icon: UserCheck, label: 'Leave Approvals', path: '/manager/leaves' },
        { icon: Clock, label: 'OT Approvals', path: '/manager/overtime' },
    ]
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', position: 'relative' }}>
                ...
                <header style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                        ...
                        <span style={{ fontSize: '0.9rem' }}>Manager</span>
                    </div>
                </header>
