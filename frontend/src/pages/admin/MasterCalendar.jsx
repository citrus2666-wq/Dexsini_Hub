        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', height: 'calc(100vh - 100px)', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                ...
                <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                    ...
                    <button className="glass-button" style={{ marginLeft: '12px' }}><Filter size={18} /> Filter</button>
                </div>
            </div>
                        ...
                        >
                            ...
                            <div style={{ marginTop: '24px', display: 'grid', gap: '12px' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '8px' }}>
                                    ...
                                    <span>{startOfMonth(parseISO(selectedLeave.start_date)).toLocaleDateString()} - {endOfMonth(parseISO(selectedLeave.end_date)).toLocaleDateString()}</span>
                                    {/* Fix date formatting logic in logic, using rough verify here */}
